...
package jones.sonar.velocity.fallback.dummy;
        ...
        super(new Channel() {
            ...
            public EventLoop eventLoop() {
                return new EventLoop() {
                    ...
                    @NotNull
                    @Override
                    public <T> List<java.util.concurrent.Future<T>> invokeAll(@NotNull Collection<? extends Callable<T>> tasks, long timeout, @NotNull TimeUnit unit) throws InterruptedException {
                        return null;
                    }
